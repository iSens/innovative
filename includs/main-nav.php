                ...
                <ul class="nav navbar-nav mb-2 mb-lg-0 inn__header-menu">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="terminals-and-distribution.php">Our Network of Terminals</a></li>
                            <li><a class="dropdown-item" href="employment-opportunities.php">Employment Opportunities</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item inn__header-menuHeader" href="agricultural-sol.php">Agricultural Solutions</a></li>
                            <li><a class="dropdown-item" href="agricultural-sol.php">CanGrow Crop Solutions</a></li>
                            <li><a class="dropdown-item inn__header-menuHeader" href="industrial-sol.php">Industrial Solutions</a></li>
                            ...
                            <li><a class="dropdown-item inn__header-menuHeader" href="treated-salt-information.php">Treated Salt Information</a></li>
                            <li><a class="dropdown-item inn__header-menuHeader" href="distributor.php">Distributors/Dealers</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- <li><a class="dropdown-item" href="testimonials-and-case-studies.php">Testimonials and Case Studies</a></li> -->
